...
namespace DrawingIO
{
    ...
    {
        public Vector3[] Vert { get { return vert; } }
        ...
        {
            extents = vert[0].Extents;
            extents.union(vert[1].Extents);
            extents.union(vert[2].Extents);
        ...
        /// <returns></returns>
        public bool project(Ray ray,  out Vector3 projPt)
        {
